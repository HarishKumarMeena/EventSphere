...
export class UsersService {
  ...
  public async create(@Body() createUserDto: CreateUserDto): Promise<User> {
    ...
    // if (!createUserDto.email.includes("nitt.edu")) {
    //   throw new HttpException('Please enter a nitt email address!', 403, {
    //     cause: new Error('Please enter a nitt email address!')
    //   })
    // }
