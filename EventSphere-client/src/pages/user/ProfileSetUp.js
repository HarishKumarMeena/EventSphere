                        ...
                        <div className="grid grid-cols-12 mt-6 gap-3">
                            ...
                            <div className="flex flex-col col-span-6">
                                <div className="flex flex-row space-x-2">
                                    ...
                                    <p className="text-sm text-neutral-400 self-center">Example: 1234567890</p>
                                </div>
                                <input type="tel" pattern="[0-9]{10}" className="px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm sm:text-sm" value={phoneNumber} onChange={e => setPhoneNumber(e.target.value)} />
                            </div>
                            <div className="flex flex-col col-span-6">
